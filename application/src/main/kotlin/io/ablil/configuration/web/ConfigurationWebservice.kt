...
@RestController
class ConfigurationWebservice(val repository: ConfigurationRepository) : ConfigurationApi {
    ...
    override fun getAllConfigurations(
        page: Int,
        size: Int,
        xTenant: String,
        ...
        val result =
            repository.findAllByStatus(ConfigurationStatus.ENABLED, PageRequest.of(page - 1, size))
    ...
    override fun getConfiguration(
        ...
        return repository.findByShortnameAndStatus(shortname)?.let {
            ResponseEntity.ok(ConfigurationMapper.to(it))
