...
object ConfigurationMapper {
    ...
    fun to(configuration: PartnerConfiguration): ConfigurationDto = ConfigurationDto(
    ...
    fun to(metadata: ConfigurationMetadata): ConfigurationMetadataDto = ConfigurationMetadataDto(
        shortName = metadata.shortname,
        description = metadata.description,
    )

    fun to(navigation: Navigation): AnyNavigationDto = object : AnyNavigationDto {
